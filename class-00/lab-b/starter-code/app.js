...
//"this" is window object when joe.scopeArrow() is invoked.
// 3. Explain why "this" is different when an arrow function is used.
//Arrow functions do not have thier own execution content. When saying this, the arrow function refers to the current scope, where it cannot find it and then looks to the enclosing scope, where it finds the window object.
